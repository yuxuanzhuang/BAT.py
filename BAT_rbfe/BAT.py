            ...
            case 'poses_list' | 'ligand_list' | 'other_mol':
                ...
                for item in newline:
                    if key == 'poses_list':
                        ...
                        ligand_list.append(item)
                    elif key == 'other_mol':
                        other_mol.append(item)
...
if stage == 'equil':
    ...
    for i in range(0, len(poses_def)):
        ...
        anch = build.build_equil(pose, celp_st, mol, H1, H2, H3, calc_type, l1_x, l1_y, l1_z, l1_range,
                                 min_adis, max_adis, ligand_ff, ligand_ph, retain_lig_prot, ligand_charge, other_mol, solv_shell)
        if anch == 'anch1':
